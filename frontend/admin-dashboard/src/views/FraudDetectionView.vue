  ...
  <div>
    <div class="page-header">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Review and investigate suspicious bidding patterns and activities.</p>
      </div>
    ...
    <div class="card mb-6">
      <div class="flex flex-col gap-3 sm:flex-row sm:items-end">
        <div class="flex-1">
          ...
          <select v-model="fraudFilters.severity" class="select">
        ...
        <div class="flex-1">
          ...
          <select v-model="fraudFilters.status" class="select">
            <option value="">All</option>
        ...
        <div class="flex-1">
          ...
          <select v-model="fraudFilters.type" class="select">
            <option value="">All types</option>
            <option value="shill_bidding">Shill Bidding</option>
            <option value="bid_manipulation">Bid Manipulation</option>
    ...
    <!-- Empty -->
    <div v-else-if="fraudAlerts.length === 0" class="card py-12 text-center">
      ...
      <h3 class="mt-4 text-lg font-medium text-gray-900">No fraud alerts</h3>
      <p class="mt-1 text-sm text-gray-500">The platform is operating normally.</p>
    </div>
    ...
    <div v-else class="space-y-4">
      ...
      >
        ...
        <!-- Expanded details -->
        <div v-if="expandedAlertId === alert.id" class="border-t border-gray-100 bg-gray-50 p-4">
          <div class="grid gap-4 md:grid-cols-2">
            ...
            <div>
              <h4 class="mb-2 text-xs font-semibold uppercase text-gray-500">Affected Users</h4>
              <div class="space-y-1">
                <router-link
          ...
          <!-- Evidence -->
          <div v-if="alert.evidence.length > 0" class="mt-4">
            <h4 class="mb-2 text-xs font-semibold uppercase text-gray-500">Evidence</h4>
            <ul class="list-inside list-disc space-y-1">
              <li v-for="(item, i) in alert.evidence" :key="i" class="text-sm text-gray-700">
                {{ item }}
              </li>
            </ul>
          </div>
          ...
          <!-- Resolution info -->
          <div v-if="alert.resolution" class="mt-4 rounded-lg bg-green-50 p-3">
            <h4 class="mb-1 text-xs font-semibold uppercase text-green-700">Resolution</h4>
            <p class="text-sm text-green-800">{{ alert.resolution }}</p>
