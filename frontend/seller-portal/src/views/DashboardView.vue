...
<template>
  <div>
    ...
    <div class="mb-6">
      ...
      <p class="mt-1 text-sm text-gray-500">Here's an overview of your selling activity.</p>
    </div>
    ...
    <div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div class="kpi-card">
        ...
        <p class="kpi-value">{{ statusCounts.active }}</p>
        <p class="kpi-label">Active Lots</p>
      </div>
      ...
      <div class="kpi-card">
        ...
        <p class="kpi-value">{{ overview?.totalBids ?? 0 }}</p>
      ...
      <div class="kpi-card">
        ...
        <p class="kpi-value">{{ statusCounts.sold }}</p>
        <p class="kpi-label">Lots Sold</p>
      </div>
      ...
      <div class="kpi-card">
        ...
        <p class="kpi-value">{{ formatCurrency(totals.totalNetAmount) }}</p>
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <div class="card lg:col-span-2">
        <div class="mb-4 flex items-center justify-between">
          ...
          <router-link to="/analytics" class="text-sm font-medium text-primary-600 hover:text-primary-700">
            View analytics
          </router-link>
        </div>
        <RevenueChart
      ...
      <div class="card">
        ...
        <div class="space-y-4">
          ...
          >
            ...
            >
              <!-- Bid icon -->
              <svg v-if="activity.type === 'bid'" class="h-4 w-4 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
              </svg>
              <!-- Approved icon -->
              <svg v-else-if="activity.type === 'approved'" class="h-4 w-4 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7" />
              </svg>
              <!-- Sold icon -->
              <svg v-else-if="activity.type === 'sold'" class="h-4 w-4 text-purple-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <!-- Settlement icon -->
              <svg v-else class="h-4 w-4 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8V7m0 8v1" />
              </svg>
            </div>
    ...
    <div class="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
      ...
      <div class="card">
        ...
        <div class="grid grid-cols-2 gap-3">
          <router-link to="/lots/create" class="card-hover flex flex-col items-center gap-2 p-4 text-center">
          ...
          <router-link to="/lots" class="card-hover flex flex-col items-center gap-2 p-4 text-center">
            <div class="rounded-lg bg-green-100 p-2">
              <svg class="h-5 w-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <router-link to="/settlements" class="card-hover flex flex-col items-center gap-2 p-4 text-center">
            <div class="rounded-lg bg-amber-100 p-2">
              <svg class="h-5 w-5 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          ...
          <router-link to="/co2-report" class="card-hover flex flex-col items-center gap-2 p-4 text-center">
      ...
      <div class="card">
        <div class="mb-4 flex items-center justify-between">
          ...
          <router-link to="/lots" class="text-sm font-medium text-primary-600 hover:text-primary-700">
            View all
          </router-link>
        </div>
        <div class="space-y-3">
