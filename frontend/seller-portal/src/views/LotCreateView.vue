...
<template>
  <div>
    ...
    <div class="mb-6">
      ...
      <h1 class="mt-2 text-2xl font-bold text-gray-900">Create New Lot</h1>
    ...
    <div v-if="submitError" class="mb-6 rounded-lg border border-red-200 bg-red-50 p-4">
      <div class="flex items-start gap-3">
        <svg class="mt-0.5 h-5 w-5 shrink-0 text-red-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
